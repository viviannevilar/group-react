...
function AboutUsPage(){
    return (
        ...
        <div className="aboutus">
            <br></br>
            <br></br>
            <h1 id="about" style={{ color: '#004aad' }}>We Love Comparing!</h1>
            ...
            <br></br>
            <div style={{ backgroundColor: '#b3b7a4' }}>
                <br></br>
            <h1 id="about" style={{ color: '#004aad' }}>How to use it!</h1>
            ...
            <br></br>          
            <h1 id="about" style={{ color: '#004aad' }}>We Love hearing from you!</h1>
