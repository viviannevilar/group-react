...
function EditCollectionForm(props) {
  ...
  const postData = async () => {
    ...
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}collection/${collectionData.id}/`,
      {
        method: "put",
        headers: {
    ...
    return (
      <div className="editcollectionform">
        <div>
          ...
          <div>
            <h2 id="editcollectionheadertitle">
              {" "}
              EDIT {collectionData.title}{" "}
            </h2>

            <h4 className="newcollectiontxt">
              <span className="error">
                {errorKey === "detail" ? errorMessage : null}
              </span>{" "}
            </h4>
            ...
            <form>
              <div className="ecfa">
                <label className="ate" htmlFor="title">
                  NAME OF COLLECTION:
                  <span className="error">
                    {errorKey === "title" ? errorMessage : null}
                  </span>
                </label>
                <textarea
                  type="textarea"
              ...
              <div className="ecfa">
                <label className="ate" htmlFor="attribute1">
                  ATTRIBUTE 1:
                  <span className="error">
                    {errorKey === "attribute1" ? errorMessage : null}
                  </span>
                </label>
                <textarea
                  type="textarea"
              ...
              <div className="ecfa">
                <label className="ate" htmlFor="attribute2">
                  ATTRIBUTE 2:
                  <span className="error">
                    {errorKey === "attribute2" ? errorMessage : null}
                  </span>
                </label>
                <textarea
                  type="textarea"
              ...
              <div className="ecfa">
                <label className="ate" htmlFor="attribute3">
                  ATTRIBUTE 3:
                  <span className="error">
                    {errorKey === "attribute3" ? errorMessage : null}
                  </span>
                </label>
                <textarea
                  type="textarea"
              ...
              <div className="ecfa">
                <label className="ate" htmlFor="attribute4">
                  ATTRIBUTE 4:
                  <span className="error">
                    {errorKey === "attribute4" ? errorMessage : null}
                  </span>
                </label>
                <textarea
                  type="textarea"
